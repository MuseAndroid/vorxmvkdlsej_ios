...
@interface FFPersonalInfoViewController ()
...
- (instancetype) init
{
    ...
    if (self)
    {
        self.title = @"  개인정보수집 및 이용에 대한 안내(필수)";
...
- (void)viewDidLoad {
    ...
    NSString *indexFile = [[NSBundle mainBundle] pathForResource:@"service_prom2" ofType:@"html"];
