...
- (instancetype) init
{
    ...
    if (self) {
        ...
        if ([_oName length] != 0) {
            ...
            [overString addAttribute:NSFontAttributeName value:[UIFont boldSystemFontOfSize:25.f] range:overRange1];
            [overString addAttribute:NSForegroundColorAttributeName value:[UIColor redColor] range:overRange2];
            [overString addAttribute:NSFontAttributeName value:[UIFont boldSystemFontOfSize:25.f] range:overRange2];
            
            _lbUserSearchHis = [[UILabel alloc] init];
            _lbUserSearchHis.backgroundColor = [UIColor clearColor];
            _lbUserSearchHis.font = [UIFont appleSDGothicNeoMediumWithSize:20.f];
...
- (void) makeConstraints
{
    ...
    if ([_oName length] != 0) {
        [_overlayContainer mas_makeConstraints:^(MASConstraintMaker *make) {
            make.top.equalTo(_contentContainer.mas_top).with.offset(20.f);
        ...
        [_smsContainer mas_makeConstraints:^(MASConstraintMaker *make) {
            make.top.equalTo(_overlayContainer.mas_bottom).with.offset(20.f);
            make.left.equalTo(_contentContainer.mas_left).with.offset(5.f);
            make.right.equalTo(_contentContainer.mas_right).with.offset(-5.f);
        ...
        [_cancelBtn mas_makeConstraints:^(MASConstraintMaker *make) {
            ...
            make.left.equalTo(_contentContainer.mas_left).with.offset(5.f);
            make.right.equalTo(_contentContainer.mas_right).with.offset(-5.f);
            make.bottom.equalTo(_contentContainer.mas_bottom).with.offset(-90.5f);
        }];
    }
