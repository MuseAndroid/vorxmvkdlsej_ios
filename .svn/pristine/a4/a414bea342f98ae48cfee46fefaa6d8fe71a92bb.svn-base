//
//  FFAgreeContent8ViewController.m
//  factFinder
//
...
@interface FFAgreeContent8ViewController ()
...
@implementation FFAgreeContent8ViewController
...
- (void) downContentBody:(NSString *)tel_com
{
    ...
    if ([tel_com isEqualToString:@"SKT"]) {
        NSString *indexFile1 = [[NSBundle mainBundle] pathForResource:@"tel_skt3" ofType:@"html"];
        NSString *htmlStringSKT3 = [NSString stringWithContentsOfFile:indexFile1 encoding:NSUTF8StringEncoding error:nil];
        
        [_webContView loadHTMLString:htmlStringSKT3 baseURL:[[NSBundle mainBundle] bundleURL]];
    } else if ([tel_com isEqualToString:@"KTF"]) {
        NSString *indexFile2 = [[NSBundle mainBundle] pathForResource:@"tel_kt3" ofType:@"html"];
        NSString *htmlStringKT3 = [NSString stringWithContentsOfFile:indexFile2 encoding:NSUTF8StringEncoding error:nil];
        
        [_webContView loadHTMLString:htmlStringKT3 baseURL:[[NSBundle mainBundle] bundleURL]];
    } else if ([tel_com isEqualToString:@"LGT"]) {
        NSString *indexFile1 = [[NSBundle mainBundle] pathForResource:@"tel_lgt3" ofType:@"html"];
        NSString *htmlStringLGT3 = [NSString stringWithContentsOfFile:indexFile1 encoding:NSUTF8StringEncoding error:nil];
        
        [_webContView loadHTMLString:htmlStringLGT3 baseURL:[[NSBundle mainBundle] bundleURL]];
    }
}
