//
//  FFUserServiceViewController.m
//  factFinder
//
//  Created by Hong Junho on . 1. 15.2018.
...
@interface FFUserServiceViewController ()
...
@implementation FFUserServiceViewController
...
- (void)viewDidLoad {
    ...
    NSString *indexFile = [[NSBundle mainBundle] pathForResource:@"service_prom1" ofType:@"html"];
